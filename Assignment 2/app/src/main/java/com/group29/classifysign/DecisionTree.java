...
class DecisionTree {
    ...
    // start changing feature and node

    private static boolean node15(double[] feature){
        if(feature[11] < 143.334){
            return node26(feature);
        } else if( feature[11] >= 143.334){
    ...
    private static boolean node16(double[] feature){
        if(feature[11] < 127.844){
            return node28(feature);
        } else if( feature[11] >= 127.844){
    ...
    private static boolean node17(double[] feature){
        if(feature[11] < 32.873){
            return false;
        } else if( feature[11] >= 32.873){
    ...
    private static boolean node18(double[] feature){
        if(feature[11] < 151.595){
            return node32(feature);
        } else if( feature[11] >= 151.595){
    ...
    private static boolean node19(double[] feature){
        if(feature[11] < 177.075){
            return node34(feature);
        } else if( feature[11] >= 177.075){
    ...
    private static boolean node22(double[] feature){
        if(feature[11] < 121.89){
            return true;
        } else if( feature[11] >= 121.89){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node23(double[] feature){
        if(feature[11] < 337.018){
            return node38(feature);
        } else if( feature[11] >= 337.018){
    ...
    private static boolean node24(double[] feature){
        if(feature[11] < 19.9827){
            return node40(feature);
        } else if( feature[11] >= 19.9827){
    ...
    private static boolean node26(double[] feature){
        if(feature[11] < 122.767){
            return false;
        } else if( feature[11] >= 122.767){
    ...
    private static boolean node27(double[] feature){
        if(feature[11] < 73.876){
            return false;
        } else if( feature[11] >= 73.876){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node28(double[] feature){
        if(feature[11] < 120.164){
            return node46(feature);
        } else if( feature[11] >= 120.164){
    ...
    private static boolean node29(double[] feature){
        if(feature[11] < 20.4221){
            return node48(feature);
        } else if( feature[11] >= 20.4221){
    ...
    private static boolean node31(double[] feature){
        if(feature[11] < 227.858){
            return node50(feature);
        } else if( feature[11] >= 227.858){
    ...
    private static boolean node32(double[] feature){
        if(feature[11] < 115.03){
            return false;
        } else if( feature[11] >= 115.03){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node33(double[] feature){
        if(feature[11] < 120.935){
            return node54(feature);
        } else if( feature[11] >= 120.935){
    ...
    private static boolean node34(double[] feature){
        if(feature[11] < 97.4728){
            return false;
        } else if( feature[11] >= 97.4728){
    ...
    private static boolean node35(double[] feature){
        if(feature[11] < 71.2788){
            return true;
        } else if( feature[11] >= 71.2788){
    ...
    private static boolean node38(double[] feature){
        if(feature[11] < 211.773){
            return node60(feature);
        } else if( feature[11] >= 211.773){
    ...
    private static boolean node39(double[] feature){
        if(feature[11] < 57.3893){
            return node62(feature);
        } else if( feature[11] >= 57.3893){
    ...
    private static boolean node40(double[] feature){
        if(feature[11] < 258.45){
            return node64(feature);
        } else if( feature[11] >= 258.45){
    ...
    private static boolean node41(double[] feature){
        if(feature[11] < 77.0423){
            return node66(feature);
        } else if( feature[11] >= 77.0423){
    ...
    private static boolean node43(double[] feature){
        if(feature[11] < 187.762){
            return node68(feature);
        } else if( feature[11] >= 187.762){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node46(double[] feature){
        if(feature[11] < 264.748){
            return node70(feature);
        } else if( feature[11] >= 264.748){
    ...
    private static boolean node47(double[] feature){
        if(feature[11] < 176.042){
            return false;
        } else if( feature[11] >= 176.042){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node48(double[] feature){
        if(feature[11] < 108.829){
            return true;
        } else if( feature[11] >= 108.829){
    ...
    private static boolean node49(double[] feature){
        if(feature[11] < 255.287){
            return node76(feature);
        } else if( feature[11] >= 255.287){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node50(double[] feature){
        if(feature[11] < 238.265){
            return false;
        } else if( feature[11] >= 238.265){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node51(double[] feature){
        if(feature[11] < 99.0194){
            return node80(feature);
        } else if( feature[11] >= 99.0194){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node54(double[] feature){
        if(feature[11] < 114.668){
            return false;
        } else if( feature[11] >= 114.668){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node55(double[] feature){
        if(feature[11] < 100.287){
            return node84(feature);
        } else if( feature[11] >= 100.287){
    ...
    private static boolean node57(double[] feature){
        if(feature[11] < 208.075){
            return false;
        } else if( feature[11] >= 208.075){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node59(double[] feature){
        if(feature[11] < 137.581){
            return true;
        } else if( feature[11] >= 137.581){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node60(double[] feature){
        if(feature[11] < 177.683){
            return false;
        } else if( feature[11] >= 177.683){
    ...
    private static boolean node61(double[] feature){
        if(feature[11] < 212.424){
            return true;
        } else if( feature[11] >= 212.424){
    ...
    private static boolean node62(double[] feature){
        if(feature[11] < 89.4306){
            return node94(feature);
        } else if( feature[11] >= 89.4306){
    ...
    private static boolean node63(double[] feature){
        if(feature[11] < 150.003){
            return node96(feature);
        } else if( feature[11] >= 150.003){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node64(double[] feature){
        if(feature[11] < 147.968){
            return true;
        } else if( feature[11] >= 147.968){
    ...
    private static boolean node65(double[] feature){
        if(feature[11] < 307.044){
            return false;
        } else if( feature[11] >= 307.044){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node66(double[] feature){
        if(feature[11] < 131.142){
            return true;
        } else if( feature[11] >= 131.142){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node67(double[] feature){
        if(feature[11] < 78.8038){
            return node104(feature);
        } else if( feature[11] >= 78.8038){
    ...
    private static boolean node68(double[] feature){
        if(feature[11] < 58.8251){
            return node106(feature);
        } else if( feature[11] >= 58.8251){
    ...
    private static boolean node70(double[] feature){
        if(feature[11] < 134.984){
            return node108(feature);
        } else if( feature[11] >= 134.984){
    ...
    private static boolean node71(double[] feature){
        if(feature[11] < 109.843){
            return true;
        } else if( feature[11] >= 109.843){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node75(double[] feature){
        if(feature[11] < 320.987){
            return false;
        } else if( feature[11] >= 320.987){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node76(double[] feature){
        if(feature[11] < 101.942){
            return false;
        } else if( feature[11] >= 101.942){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node80(double[] feature){
        if(feature[11] < 202.585){
            return true;
        } else if( feature[11] >= 202.585){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node84(double[] feature){
        if(feature[11] < 115.263){
            return node118(feature);
        } else if( feature[11] >= 115.263){
    ...
    private static boolean node85(double[] feature){
        if(feature[11] < 178.401){
            return true;
        } else if( feature[11] >= 178.401){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node93(double[] feature){
        if(feature[11] < 113.675){
            return true;
        } else if( feature[11] >= 113.675){
    ...
    private static boolean node95(double[] feature){
        if(feature[11] < 128.892){
            return true;
        } else if( feature[11] >= 128.892){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node99(double[] feature){
        if(feature[11] < 171.115){
            return true;
        } else if( feature[11] >= 171.115){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node104(double[] feature){
        if(feature[11] < 313.332){
            return node134(feature);
        } else if( feature[11] >= 313.332){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node105(double[] feature){
        if(feature[11] < 21.2809){
            return node136(feature);
        } else if( feature[11] >= 21.2809){
    ...
    private static boolean node106(double[] feature){
        if(feature[11] < 122.873){
            return true;
        } else if( feature[11] >= 122.873){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node107(double[] feature){
        if(feature[11] < 137.021){
            return true;
        } else if( feature[11] >= 137.021){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node108(double[] feature){
        if(feature[11] < 75.431){
            return true;
        } else if( feature[11] >= 75.431){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node109(double[] feature){
        if(feature[11] < 221.788){
            return node144(feature);
        } else if( feature[11] >= 221.788){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node118(double[] feature){
        if(feature[11] < 207.726){
            return node146(feature);
        } else if( feature[11] >= 207.726){
    ...
    private static boolean node119(double[] feature){
        if(feature[11] < 282.182){
            return node148(feature);
        } else if( feature[11] >= 282.182){
    ...
    private static boolean node125(double[] feature){
        if(feature[11] < 335.023){
            return true;
        } else if( feature[11] >= 335.023){
    ...
    private static boolean node134(double[] feature){
        if(feature[11] < 113.279){
            return true;
        } else if( feature[11] >= 113.279){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node136(double[] feature){
        if(feature[11] < 139.285){
            return true;
        } else if( feature[11] >= 139.285){
            return false;
        } else {
            return true;
        }
    ...
    private static boolean node137(double[] feature){
        if(feature[11] < 298.683){
            return node156(feature);
        } else if( feature[11] >= 298.683){
    ...
    private static boolean node144(double[] feature){
        if(feature[11] < 49.2571){
            return false;
        } else if( feature[11] >= 49.2571){
    ...
    private static boolean node146(double[] feature){
        if(feature[11] < 279.239){
            return false;
        } else if( feature[11] >= 279.239){
    ...
    private static boolean node147(double[] feature){
        if(feature[11] < 329.064){
            return node162(feature);
        } else if( feature[11] >= 329.064){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node148(double[] feature){
        if(feature[11] < 122.572){
            return node164(feature);
        } else if( feature[11] >= 122.572){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node149(double[] feature){
        if(feature[11] < 179.024){
            return true;
        } else if( feature[11] >= 179.024){
            return false;
        } else {
            return false;
        }
    ...
    private static boolean node151(double[] feature){
        if(feature[11] < 109.192){
            return false;
        } else if( feature[11] >= 109.192){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node156(double[] feature){
        if(feature[11] < 239.679){
            return true;
        } else if( feature[11] >= 239.679){
    ...
    private static boolean node157(double[] feature){
        if(feature[11] < 79.6428){
            return node172(feature);
        } else if( feature[11] >= 79.6428){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node159(double[] feature){
        if(feature[11] < 12.5888){
            return false;
        } else if( feature[11] >= 12.5888){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node161(double[] feature){
        if(feature[11] < 52.4585){
            return false;
        } else if( feature[11] >= 52.4585){
            return true;
        } else {
            return true;
        }
    ...
    private static boolean node162(double[] feature){
        if(feature[11] < 65.4442){
            return false;
        } else if( feature[11] >= 65.4442){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node164(double[] feature){
        if(feature[11] < 96.1675){
            return false;
        } else if( feature[11] >= 96.1675){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node171(double[] feature){
        if(feature[11] < 86.6145){
            return false;
        } else if( feature[11] >= 86.6145){
            return true;
        } else {
            return false;
        }
    ...
    private static boolean node172(double[] feature){
        if(feature[11] < 129.762){
            return false;
        } else if( feature[11] >= 129.762){
            return true;
        } else {
            return true;
        }
